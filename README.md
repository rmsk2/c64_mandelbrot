...
To calculate a viusalization of the default section of the Mandelbrot set using the default maximum iteration depth of 24 in multicolor mode takes about 43 minutes and the software has to perform 327905 iterations (126 iterations/sec). In hires mode the visualization of the default section with
