...
To calculate a viusalization of the default section of the Mandelbrot set using the default maximum iteration depth of 24 in multicolor mode takes less than 40 minutes and the software has to perform 327905 iterations (140 iterations/sec). In hires mode the visualization of the default section with
a maximum iteration depth of 24 is done within one hour and 26 minutes. 