...
mandelbr.d64: mandelbr
	$(C1541) -format mandelbr,2j d64 $(WORKDIR)/mandelbr.d64 -write $(WORKDIR)/mandelbr -write $(WORKDIR)/multidefault.pic "mdefault.pic,s" -write $(WORKDIR)/hiresdefault.pic "hdefault.pic,s"
